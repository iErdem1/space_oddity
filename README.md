...
## DESIGN OVERVIEW:
- There is no known design pattern used.
- Generally brute force searching applied. Probe starts to search first object in the stars_list object list. Then search the list iterationally.
- Search algorithm is not efficient.

## KNOWN BUGS AND INCOMPLETE PARTS:
- There is no detectable bugs. If you can find please generate an issue on Github.

## REFERENCES:
- Python 3.6 documentation. *doc.python.org*

## MISCELLANEOUS COMMENTS:
- Fuel may out. You can change the initial fuel value.
